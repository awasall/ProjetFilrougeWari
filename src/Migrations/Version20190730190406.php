 ...
 */
final class Version20190730190406 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE partenaire (id INT AUTO_INCREMENT NOT NULL, ninea VARCHAR(255) NOT NULL, raisonsociale VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, telephone VARCHAR(12) NOT NULL, numerocompte BIGINT NOT NULL, solde BIGINT NOT NULL, email VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_32FFA373C678AEBE (ninea), UNIQUE INDEX UNIQ_32FFA373176C17B6 (raisonsociale), UNIQUE INDEX UNIQ_32FFA373450FF010 (telephone), UNIQUE INDEX UNIQ_32FFA373EA9195C1 (numerocompte), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
